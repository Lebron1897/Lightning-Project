      ...
      switch(R) {           
        case 0:
            for(int i=0; i<6; i++) { // For each pixel in strip...
              strip[0].setPixelColor(i, 0,255,0);         //  Set pixel's color (in RAM)
        ...
        case 1:
            for(int i=0; i<6; i++) { // For each pixel in strip...
              strip[1].setPixelColor(i, 0,255,0);         //  Set pixel's color (in RAM)
        ...
        case 2:
            for(int i=0; i<6; i++) { // For each pixel in strip...
              strip[2].setPixelColor(i, 0,255,0);         //  Set pixel's color (in RAM)
        ...
        case 3:
            for(int i=0; i<6; i++) { // For each pixel in strip...
              strip[3].setPixelColor(i, 0,255,0);         //  Set pixel's color (in RAM)
        ...
        case 4:
            for(int i=0; i<6; i++) { // For each pixel in strip...
              strip[4].setPixelColor(i, 0,255,0);         //  Set pixel's color (in RAM)
        ...
        case 5:
            for(int i=0; i<6; i++) { // For each pixel in strip...
              strip[5].setPixelColor(i, 0,255,0);         //  Set pixel's color (in RAM)
        ...
        case 6:
            for(int i=0; i<6; i++) { // For each pixel in strip...
              strip[6].setPixelColor(i, 0,255,0);         //  Set pixel's color (in RAM)
...
//---------------------------------------------------//
  void INI(){
    for(int j=0; j<7;j++){
    for(int i=0; i<6; i++) { // For each pixel in strip...
       strip[j].setPixelColor(i, 255,0,255);         //  Set pixel's color (in RAM)
       strip[j].show();                          //  Update strip to match
       delay(1);                           //  Pause for a moment
    }//for
    delay(500);
